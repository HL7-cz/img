...
* intendedRecipient 0..* IntendedRecipientCz "A.1.4 - Intended recipient - (intended recipient or recipients of the report), if applicable" """Intended recipient - (intended recipient or recipients of the report), if applicable"""
