...
* category 1..1 CodeableConcept "A.1.8.2 - Document category" """Identifies the category of document at hand, e.g. Imaging report."""
...
* custodian 1..1 Base "A.1.8.6 - Report custodian" """Organisation that is in charge of maintaining the report [this element will include organisation ID, name, address etc., as other elements describing organisations]."""
