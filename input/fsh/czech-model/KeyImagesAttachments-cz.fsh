...
* priloha 1..1 Base "A.2.6.9 - Příloha" """Přímo vložená data nebo odkaz na zdroj dat přílohy."""
* priloha.datum 0..* dateTime "A.2.6.9 - Datum" """Datum obsahu přílohy, např. datum, kdy byla fotografie pořízena."""
* priloha.nazev 0..1 string "A.2.6.9 - Název" """Popisek, který bude zobrazen před daty."""
* priloha.velikost 0..1 integer "A.2.6.9 - Velikost" """Počet bajtů obsahu (je-li uvedeno url)."""
* priloha.hash 0..1 base64Binary "A.2.6.9 - Hash" """Vypočítaný hash dat (sha-1, base64ed)."""
* priloha.url 0..1 uri "A.2.6.9 - URL" """Uri, kde lze data nalézt."""
* priloha.data 0..1 base64Binary "A.2.6.9 - Data" """Skutečná data přílohy - posloupnost bajtů, kódovaná v base64."""
* priloha.typObsahu 0..1 CodeableConcept "A.2.6.9 - Typ obsahu" """MIME typ obsahu, včetně sady znaků atd."""
