...
* species 0..1 CodeableConcept "A.2.3.2 Type of species" """Biological species refers to samples taken from non-human subjects. - Preferred system(s): SNOMED CT [TypeOfSpeciesCodelist]"""				
...
* collectionDate 0..1 dateTime "A.2.3.4 Collection period" """Date and time or duration of sample collection. - Preferred system(s): ISO 8601"""				
...
* procedure 0..1 CodeableConcept "A.2.3.8 Collection procedure/method" """Method, manner of sample collection, if relevant to the results. - Preferred system(s): SNOMED CT [CollectionMethodCodelist]"""				
