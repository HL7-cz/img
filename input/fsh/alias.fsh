...
Alias: $hl7-allergyintoleranceclinicalstatus = http://terminology.hl7.org/CodeSystem/allergyintolerance-clinical
Alias: $dlp_lecivePripravky = https://sukl.cz/terminology/CodeSystem/dlp-lecivepripravky
Alias: $edqm = http://standardterms.edqm.eu
//Alias: $dlp_formy_cs = https://sukl.cz/terminology/CodeSystem/dlp-formy
...
Alias: $sct-condition-code = https://ncez.mzcr.cz/terminology/ValueSet/condition-code
Alias: $hl7-condition-category = http://hl7.org/fhir/ValueSet/condition-category
Alias: $mkn-10-problem-list = https://uzis.cz/terminology/ValueSet/mkn-10
...
Alias: $dlp_formy = https://sukl.cz/terminology/ValueSet/dlp-formy
