Logical: LogEnKeyImagesAttachmentCz
...
* author 0..1 Base "A.2.6.3 - Created by" """Person who created the image."""
...
* author.organization 1..1 Base "A.2.6.3.4 - Author organisation" """The healthcare provider organisation information."""
...
* attachment 1..1 Base "A.2.6.9 - Attachment" """Directly embedded data or a link to the attachment's data source."""
* attachment.date 0..* dateTime "A.2.6.9.1 - Date" """Date of the attachment content, e.g., the date a photo was taken."""
* attachment.title 0..1 string "A.2.6.9.2 - Title" """Label to display in place of the data."""
* attachment.size 0..1 integer "A.2.6.9.3 - Size" """Number of bytes of content (if url provided)."""
* attachment.hash 0..1 base64Binary "A.2.6.9.4 - Hash" """The calculated hash of the data (sha-1, base64ed)."""
* attachment.url 0..1 uri "A.2.6.9.5 - URL" """Uri where the data can be found."""
* attachment.data 0..1 base64Binary "A.2.6.9.6 - Data" """The actual data of the attachment - a sequence of bytes, base64 encoded."""
* attachment.contentType 0..1 CodeableConcept "A.2.6.9.7 - Content type" """Mime type of the content, with charset etc."""
