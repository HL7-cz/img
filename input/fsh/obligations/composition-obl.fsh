...
* extension[diagnosticReport] insert OblCreator(#SHALL:able-to-populate,L1)
...
* extension[diagnosticReport] insert OblCreator(#SHALL:able-to-populate,L2)
...
* extension[diagnosticReport] insert OblCreator(#SHALL:able-to-populate,L3)
...
* extension[diagnosticReport] insert OblConsumer(#SHALL:display,L1)
...
* extension[diagnosticReport] insert OblConsumer(#SHALL:display,L2)
...
* extension[diagnosticReport] insert OblConsumer(#SHALL:display,L3)
