Logical: LogEnHeaderImagingReportCz
...
* informationRecipient 0..* InformationRecipientCz "A.1.4 - Information recipient - (intended recipient or recipients of the report), if applicable" """Information recipient - (intended recipient or recipients of the report), if applicable"""
* author 1..* AuthorCz "A.1.5 - Author (by whom the Hospital discharge report was/were authored). Multiple authors could be provided." """Author (by whom the Hospital discharge report was/were authored). Multiple authors could be provided."""
