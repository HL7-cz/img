...
6. Obligations for profile Practitioner Role ([CZ_PractitionerRoleObligationsImg](StructureDefinition-cz-practitionerRole-obl-img.html))
...
18. Obligations for profile Medication ([CZ_MedicationObligationsImg](StructureDefinition-cz-medication-obl-img.html))
19. Obligations for profile Medication administration ([CZ_MedicationAdministrationObligationsImg](StructureDefinition-cz-medicationAdministration-obl-img.html))
...
23. Obligations for profile Specimen ([CZ_SpecimenObligationsImg](StructureDefinition-cz-specimen-obl-img.html))
24. Obligations for profile Study imaging ([CZ_StudyImagingObligationsImg](StructureDefinition-cz-studyImaging-obl-img.html))