...
* performer 0..*
  ...
  * function 1..1
  * actor only Reference(CZ_PractitionerCore or CZ_PractitionerRoleCore or CZ_OrganizationCore or CZ_PatientCore or CZ_RelatedPersonCore or CZ_DeviceObserver)
...
* focalDevice.manipulated only Reference(CZ_DeviceObserver)
* usedReference only Reference(CZ_DeviceObserver or CZ_Medication or Substance)
