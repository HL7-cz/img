...
* resultOfImagingMethod 1..1 Base "A.2.4.9 - Result of the imaging method" """Section Reports from imaging methods containing narrative result and optionally formalized result using coding systems"""
...
* resultOfImagingMethod.formalizedText 0..* Base "A.2.4.9.2 - Formalized text" """Formalized structured result of the imaging method"""
