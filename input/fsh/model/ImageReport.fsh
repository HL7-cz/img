...
* body 0..1 BodyImagingReportCz "A.2 - Imaging Report body data element" """Imaging Report body data element"""
...
* attachments 0..* AttachmentsCz "A.4 - Attachments" """Additional attachment"""