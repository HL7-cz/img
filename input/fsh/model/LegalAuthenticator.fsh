Logical: LogEnLegalAuthenticatorImagingCz
...
* organization 1..1 Base "A.1.7.4 - Legal authenticator organisation" """The healthcare provider organisation information."""
