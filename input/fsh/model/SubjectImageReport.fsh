Logical: LogEnSubjectImagingReportCz
Id: SubjectCz
...
* subjectContact.preferredHP.organization 0..1 Base "A.1.2.2.4 - HP Organisation" """Health professional organisation"""
...
* subjectContact.contactPerson 0..* Base "A.1.2.3 - Contact person/ legal guardian (multiple contacts could be provided)" """Contact person/ legal guardian (multiple contacts could be provided)"""
* subjectContact.contactPerson.type 0..* CodeableConcept "A.1.2.3.1 - Type of contact" """Type of contact"""
...
* subjectContact.contactPerson.identifier 0..* Identifier "A.1.2.3.3 - Identifier" """Identifier of the contact person/guardian . This field can contain more than one element."""
