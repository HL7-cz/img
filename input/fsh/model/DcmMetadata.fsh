...
* requestingPhysician 0..1 Base "A.2.7.6 - Requesting Physician - DICOM tag (0032,1032), (0032,1031)" """Service requester (referring physician or physician referring the patient)."""
...
* performingPhysician 0..1 Base "A.2.7.8 - Performing Physicians - DICOM tag: (0008,1050), (0008,1052)" """Healthcare professional who evaluated the study (interpreted the images or other content)."""
* performingPhysician.identifier 1..* Identifier "A.2.7.8.1 - Performing Physician Identification - DICOM tag (0008,1052)" """Identification of the physician(s) administering the Series. One or more Items are permitted in this Sequence. If more than one Item, the number and report shall correspond to the value of Performing Physician's Name (0008,1050), if present."""
...
* institutionalDepartName 0..* string "A.2.7.9 - Institutional Department Name - DICOM tag (0008,1040)" """Location (organization) where the study was conducted."""
* radiopharmaInfoSeq 0..* id "A.2.7.10 - Radiopharmaceutical Information Sequence - DICOM tag (0054,0016)" """Radiation exposure from internal irradiation (following the administration of radiopharmaceuticals, expressed as a value in standard SI units [Bq])."""
* series 0..* Base "A.2.7.11 - RT Series information" """Information from individual series (for example, their names)."""
