...
* performer[performer]
  * function
    ...
    * coding[healthcare-professional] = $sctCZ#223366009 "Healthcare professional" // TODO check this code
...
* performer[imaging-device]
  * function
    ...
    * coding[imaging-equipment] = $sctCZ#314789007 "Diagnostic imaging equipment" // TODO check this code
