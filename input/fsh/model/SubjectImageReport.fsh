...
* subjectContact.contactPerson.identifier 1..* Identifier "A.1.2.3.3 - Identifier" """Identifier of the contact person/guardian . This field can contain more than one element."""
